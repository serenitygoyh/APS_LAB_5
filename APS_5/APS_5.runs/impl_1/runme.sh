...
HD_PWD='C:/Users/danil/Desktop/5_sem/APS/APS_4/APS_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_proc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple_proc.tcl -notrace
