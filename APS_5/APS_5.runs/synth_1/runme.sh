...
HD_PWD='C:/Users/danil/Desktop/5_sem/APS/APS_4/APS_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_proc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_proc.tcl
